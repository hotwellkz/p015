...
Если сборка падает из-за обнаружения Firebase API ключей, добавьте в Netlify Dashboard → Site settings → Environment variables:
...
**Примечание:** Эти переменные должны быть установлены в Netlify Dashboard, а не в файле `.env`.
